...
.bg{position:fixed;inset:0;z-index:0;background:radial-gradient(circle at 20% 10%,rgba(0,255,102,.07),transparent 35%),radial-gradient(circle at 85% 70%,rgba(0,180,255,.05),transparent 30%),#000205}.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(0,255,102,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(0,255,102,.035) 1px,transparent 1px);background-size:45px 45px;z-index:0;mask-image:linear-gradient(to bottom,#000,transparent 90%)}.candles{position:fixed;top:105px;bottom:45px;width:92px;z-index:1;pointer-events:none;display:flex;align-items:center;justify-content:space-around;opacity:.34;filter:drop-shadow(0 0 8px rgba(0,255,102,.22))}.candles-left{left:0}.candles-right{right:0;transform:scaleX(-1)}.candles i{position:relative;display:block;width:7px;height:var(--h);background:var(--c);border-radius:1px;animation:marketMove var(--d) ease-in-out infinite alternate;transform:translateY(var(--y));box-shadow:0 0 8px var(--c)}.candles i:before{content:'';position:absolute;left:3px;top:-18px;width:1px;height:calc(100% + 36px);background:var(--c);opacity:.9}.candles i:nth-child(1){--h:34px;--y:120px;--c:#00ff66;--d:2.7s}.candles i:nth-child(2){--h:58px;--y:55px;--c:#ff3344;--d:3.2s}.candles i:nth-child(3){--h:28px;--y:170px;--c:#00ff66;--d:2.4s}.candles i:nth-child(4){--h:76px;--y:15px;--c:#ff3344;--d:3.7s}.candles i:nth-child(5){--h:43px;--y:95px;--c:#00ff66;--d:2.9s}.candles i:nth-child(6){--h:66px;--y:205px;--c:#ff3344;--d:3.4s}.candles i:nth-child(7){--h:31px;--y:145px;--c:#00ff66;--d:2.6s}.candles i:nth-child(8){--h:52px;--y:25px;--c:#ff3344;--d:3.1s}.candles i:nth-child(9){--h:40px;--y:225px;--c:#00ff66;--d:2.8s}.candles i:nth-child(10){--h:70px;--y:75px;--c:#ff3344;--d:3.6s}@keyframes marketMove{from{margin-top:-10px}to{margin-top:10px}}
...
@media(max-width:760px){.candles{opacity:.16;width:45px}.candles-left{left:-5px}.candles-right{right:-5px}.hero{grid-template-columns:1fr;padding-top:40px}.hero-card{height:260px}.cards,.steps,.feature{grid-template-columns:1fr}.pricing{grid-template-columns:1fr 1fr}.signal-grid{grid-template-columns:1fr}.section{padding:38px 0}.hero h1{font-size:43px}.image-card{min-height:300px}}
</style>'''
